-- Script to list all shows from the hbtn_0d_tvshows database that have no genre linked.
...
-- The WHERE clause filters the results to only include rows where tv_show_genres.genre_id is NULL, meaning no genre is linked to the show.
